...
public class Manager extends Persona {
    ...
    public Manager(String nome, String cognome, Date dataDiNascita, String username, String password) throws ConnectionSQLFailException, InserisciManagerFailException {
        ...
        try {
            ...
            try {
                ...
                statement.setTimestamp(5, new java.sql.Timestamp(dataDiNascita.getTime()+3600000));
        ...
        if (instance == null) {
            try {
                ...
                if (initialKey.equalsIgnoreCase("true")) {
                    instance = new Manager(s.nextLine(), s.nextLine(), new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").parse(s.nextLine()), "admin", s.nextLine());
                    f.delete();
                    f.createNewFile();
                    ...
                    else return instance = new Manager("Amministratore", "TeleTaxi",
                            new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").parse(new Date().toString()), "admin", "admin");
                } else return instance = new Manager("Amministratore", "TeleTaxi",
                        new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").parse(new Date().toString()), "admin", "admin");
    ...
    public synchronized OperatoreTelefonico addOperatoreTelefonico(OperatoreTelefonico o) throws InserisciOperatoreFailException {
        ...
        try {
            ...
            statement.setTimestamp(4, new java.sql.Timestamp(o.getDataDiNascita().getTime()+3600000));
    ...
    public synchronized OperatoreTelefonico updateOperatoreTelefonico(OperatoreTelefonico op) throws UpdateOperatoreTelefonicoFailException {
        try {
            ...
            ps.setTimestamp(3, new java.sql.Timestamp(op.getDataDiNascita().getTime()+3600000));
